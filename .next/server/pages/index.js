...
async function getStaticProps() {
  // fetch data from an API
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://dias:CaQJQMfOmdnhKGiZ@cluster0.okrnfr9.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
